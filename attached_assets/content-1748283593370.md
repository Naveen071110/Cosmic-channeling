[Skip to main content](https://help.medium.com/hc/en-us/articles/214151487-Medium-API-Terms-of-Use#main-content)
...
**How can I stay up to date on the terms?** We might update these terms from time to time. But we’ll keep up-to-date terms at this URL and save each version on [GitHub](https://github.com/Medium/medium-policy/blob/master/api-terms-of-use.md).
...
- [Medium API Terms of Use](https://help.medium.com/hc/en-us/articles/214151487-Medium-API-Terms-of-Use#medium-api-terms-of-use-0-0)
