    ...
    <>
      <header className="py-4 px-6 flex justify-between items-center border-b border-[#334155]">
        ...
        <nav className="hidden md:flex space-x-6">
          ...
          <Link href="/blog" className={`transition-colors ${isActive('/blog') ? 'text-[#F1F5F9]' : 'text-[#64748B] hover:text-[#0EA5E9]'}`}>
            Blog
          </Link>
          <Link href="/religions" className={`transition-colors ${isActive('/religions') ? 'text-[#F1F5F9]' : 'text-[#64748B] hover:text-[#0EA5E9]'}`}>
            Religions
          </Link>
          <Link href="/downloads" className={`transition-colors ${isActive('/downloads') ? 'text-[#F1F5F9]' : 'text-[#64748B] hover:text-[#0EA5E9]'}`}>
            Downloads
          </Link>
        </nav>
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 bg-[#0F172A] bg-opacity-95 z-50 p-6">
          ...
          <nav className="flex flex-col space-y-6 items-center text-xl">
            ...
            <Link href="/blog" onClick={closeMenu} className={isActive('/blog') ? 'text-[#F1F5F9]' : 'text-[#64748B] hover:text-[#0EA5E9] transition-colors'}>
              Blog
            </Link>
            <Link href="/religions" onClick={closeMenu} className={isActive('/religions') ? 'text-[#F1F5F9]' : 'text-[#64748B] hover:text-[#0EA5E9] transition-colors'}>
              Religions
            </Link>
            <Link href="/downloads" onClick={closeMenu} className={isActive('/downloads') ? 'text-[#F1F5F9]' : 'text-[#64748B] hover:text-[#0EA5E9] transition-colors'}>
              Downloads
            </Link>
          </nav>
        </div>
