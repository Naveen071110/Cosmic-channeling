  ...
  const loadCosmicImages = () => {
    const staticImages: CosmicImage[] = [
      ...
      },
      {
        ...
        largeImageUrl: "https://images.unsplash.com/photo-1502134249126-9f3755a50d78?w=1200",
        category: "nebulae",
        tags: ["nebula", "orion", "bright", "visible"],
        photographer: "Hubble",
        views: 28000,
        fact: "The Orion Nebula is a stellar nursery where new stars are actively being formed"
      },
      {
        id: "8",
        title: "Saturn's Rings",
        description: "The magnificent ring system of Saturn",
        imageUrl: "https://images.unsplash.com/photo-1614313913007-2b4ae8ce32d6?w=400",
        largeImageUrl: "https://images.unsplash.com/photo-1614313913007-2b4ae8ce32d6?w=1200",
        category: "planets",
        tags: ["saturn", "rings", "planet", "gas giant"],
        photographer: "Cassini",
        views: 21000,
        fact: "Saturn's rings are made mostly of ice particles ranging in size from tiny grains to house-sized chunks"
      }
    ];
